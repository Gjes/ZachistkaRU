class CfgCommunicationMenu
{
	...
	class AMMO
	{
		...
		submenu = ""; // Submenu opened upon activation
		expression = "ghst_ammodrop = [player,(getmarkerpos ""ghst_player_support""),""B_Heli_Transport_03_F"",""B_supplyCrate_F"",150,30] spawn ghst_fnc_ammodrop;"; // Code executed upon activation (ignored when the submenu is not empty)
		icon = "\a3\Ui_f\data\GUI\Cfg\CommunicationMenu\supplydrop_ca.paa"; // Icon displayed permanently next to the command menu
		cursor = "\a3\Ui_f\data\IGUI\Cfg\Cursors\iconCursorSupport_ca.paa"; // Custom cursor displayed when the item is selected
		enable = "1"; // Simple expression condition for enabling the item
	};
	class CARGO
	{
		...
		submenu = ""; // Submenu opened upon activation
		expression = "ghst_drop = [player,(getmarkerpos ""ghst_player_support""),""B_Heli_Transport_03_F"",200,30] spawn ghst_fnc_cargodrop;"; // Code executed upon activation (ignored when the submenu is not empty)
		icon = "";//"\a3\Ui_f\data\GUI\Cfg\CommunicationMenu\supplydrop_ca.paa"; // Icon displayed permanently next to the command menu
		cursor = "\a3\Ui_f\data\IGUI\Cfg\Cursors\iconCursorSupport_ca.paa"; // Custom cursor displayed when the item is selected
		enable = "1"; // Simple expression condition for enabling the item
	};
