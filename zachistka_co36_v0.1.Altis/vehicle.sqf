...
//		if (typeOf _unit in ["I_Heli_light_03_unarmed_F"]) then { _unit setVehicleInit "handle = [this, 5, 20, 0, false, false, "this addEventHandler ['GetIn', {_this execVM 'ourvecs.sqf'}];"] execVM "vehicle.sqf"; this addEventHandler ["GetIn", {_this execVM "ourvecs.sqf"}];";
//		processInitCommands;}; 
    };
};