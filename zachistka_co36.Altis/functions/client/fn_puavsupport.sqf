//V1 Script by: Ghost - calls in a support personal UAV "B_UAV_01_F"
//
...
if (player getVariable "ghst_puavsup") exitwith {hint format ["%1 Support Busy", _veh_name];};
...
player setVariable ["ghst_puavsup", true];
